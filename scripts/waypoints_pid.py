...
def get_exp_sequence(exp_option):
    ...
    p6a = ['FD-null', 'DF_OBS-early', 'CB-early', 'BA-late', 'AE-late', 'EC-early', 'CE-late', 'ED-late', 'DA-late', 'AD-early', 'DB-early', 'BF-late', 'FD-late', 'DC-early', 'CA_OBS-late', 'AD-early', 'DB-early', 'BA-late', 'AC-late', 'CE-late', 'ED-late', 'DE-late', 'EA-early', 'AE-late', 'EB-late', 'BD-late', 'DA-late', 'AF-early', 'FA-early', 'AD-early', 'DF_OBS-early']

    p6b = ['FD-null',  'DF_OBS-early', 'CB-late', 'BA-early', 'AE-early', 'EC-late', 'CE-early', 'ED-early', 'DA-early', 'AD-late', 'DB-late', 'BF-early', 'FD-early', 'DC-late', 'CA_OBS-early', 'AD-late', 'DB-late', 'BA-early', 'AC-early', 'CE-early', 'ED-early', 'DE-early', 'EA-late', 'AE-early', 'EB-early', 'BD-early', 'DA-early', 'AF-late', 'FA-late', 'AD-late', 'DF_OBS-late']
