...
def get_exp_sequence(exp_option):
    ...
    p4a = ['AD-null', 'DF_OBS-early', 'FC-late', 'CA_OBS-late', 'AF-early', 'FB-early', 'BA-late', 'AE-late', 'ED-late', 'DF-late', 'FB-early', 'BE-late']
    ...
    p6b = ['FC-null', 'CF-late', 'FA-late', 'AD-late', 'DF_OBS-late']
