...
def get_exp_sequence(exp_option):
    ...
    p4a = ['AF-null', 'BF-late', 'FE-late', 'DF_OBS-early', 'FC-late', 'CF-early', 'FA-early', 'AC-late', 'CB-early', 'BF-late', 'FE-late', 'EC-early', 'CA_OBS-late', 'AF-early', 'FB-early', 'BA-late', 'AE-late', 'ED-late', 'DF-late', 'FB-early', 'BE-late']
